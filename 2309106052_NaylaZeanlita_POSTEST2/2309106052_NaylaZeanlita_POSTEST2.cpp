...
// ARRAY KARYAWAN UNTUK MENYIMPAN DATA KARYAWAN DAN JABATANNYA
// CREATE
...
// STRUCT GAJI UNTUK MEMBUAT ARRAY DATA GAJI DARI STRUCT KARENA DENGAN ARRAY SAJA TIDAK DAPAT MENAMPUNG TIPE DATA BERBEDA  
struct Gaji{
        string Nama;
        int Jamkerja;
        int GajiPerjam;
...
// FUNGSI CRUD YANG HANYA BISA DI AKSES ADMIN
void CRUD(){
    // MENU ADMIN
    // DEKLARASI VARIABEL 
    int MenuAdmin;
